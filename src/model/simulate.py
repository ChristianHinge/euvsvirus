...
def simulate_county(fips, duration, I0=1, intervals=None, interval_beta_factors=None):
    ...
    :return: 
    """
    arr = _simulate_county(fips, duration, I0=I0, intervals=intervals, interval_beta_factors=interval_beta_factors)
    ages = fips2age[fips]
    ...
    arr["ICU"] = 0
    for ICU_day in range(5):
        arr.loc[:-ICU_day-1, "ICU"] += daily_dead[ICU_day:]
    return arr
